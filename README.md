...
./goall.sh
```
goall.sh calls following four shell scripts:
...
The resultant figures (png format) will be appeard in ../dtaAnalysis/.
Please make sure that you have to prepare the learning datasets in advance. (If you want to customize the dataset.) 
...
The filename show the property of the recorded data:
```
