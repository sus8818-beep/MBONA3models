...
After finishing the programs, you can find archived result files in results/, which are generated by goall4model[1-3].sh.
The archived files are used by ```../dataAnalysis/goallDataAnalysis.sh``` to generate figures in png format.
The figures will be appeard in ```../dataAnalysis/```.
Please make sure that you have to prepare your datasets for the learning in advance. (If you want to customize the dataset.) 
