...
plot '../results/combined_LRU1-0.99.csv' ti 'P=0.1','../results/combined_LRU3-0.99.csv' ti 'P=0.3','../results/combined_LRU5-0.99.csv' ti 'P=0.5','../results/combined_LRU7-0.99.csv' ti 'P=0.7', '../results/combined_LRU9-0.99.csv' ti 'P=0.9', x ti 'y=x'
#pause -1
#    EOF
