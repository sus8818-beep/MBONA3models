...
plot '../results/combined_LRU1-0.99.csv' ti '(Ps,Pc)=(0.1,0.5)', '../results/combined_LRU5-0.99.csv' ti '(Ps,Pc)=(0.5,0.5)', '../results/combined_LRU9-0.99.csv' ti '(Ps,Pc)=(0.9,0.5)', x ti 'y=x'
#pause -1
#    EOF
